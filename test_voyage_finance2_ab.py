...
(domain-specific finance embedding, per the Gemini/Kimi/Grok consultation -
see promt_dlya_kimi_uluchshenie_tochnosti.md and the follow-up threads).
...
Usage (Colab, after the usual %cd + secrets-loading cells):
    !python test_voyage_finance2_ab.py
"""
