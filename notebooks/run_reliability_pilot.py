...
(claude/nedeterminizm_judge_ekspertiza.md, section 8, point 1 - "Track A /
Track B" design, converged on by all four external experts).
...
per the remediation plan's point 7 (future logging additions) and the
instrumentation gap flagged in claude/grok_followup.md (raw response not
logged made an earlier length-correlated-noise hypothesis untestable).
...
mounted at /content/drive):
    !python notebooks/run_reliability_pilot.py
"""
