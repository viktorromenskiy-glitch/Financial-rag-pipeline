...
Usage (Colab, repo root, after setup_temp_cluster_corpus.py and
create_temp_cluster_indexes.py have both finished):
    !python test_enrichment_reranker_full_corpus.py
"""
