...
Production-обв'язка на кшталт Docker/FastAPI/observability, присутня у деяких конкурентів-портфоліо (див. «Порівняння зі схожими портфоліо-проєктами з фінансового RAG» нижче) — не прийнято: це не закриває реальну прогалину цього проєкту (retrieval/generation error attribution — див. docs/tehnicheskoe_zadanie.md, розділ 21), а копіювання інфраструктурної поверхні конкурентів не підсилило б власну сильну сторону проєкту — вимірювальну строгість.
