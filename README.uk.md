...
Ключові цифри: 76.8% точність відповідей end-to-end (retrieval + reranking + generation + оцінка суддею, n=250), і етап retrieval, що перевершує найближче опубліковане порівняння на +11–13 в.п. (див. «Порівняння з публікаціями» нижче). Оцінна вартість обслуговування: близько $0.016 за запитання (~1.6 цента) після індексації корпусу — повний висновок у розділі «Unit-економіка» нижче.

Що це, без прикрас: строго виміряна відповідь на питання «які архітектурні рішення RAG реально допомагають на складних фінансових документах і наскільки» — кожне твердження нижче підкріплене статистичним тестом проти власного baseline проєкту, а не одним демо-прогоном. Чим це не є: виробничою системою — поки немає класифікатора на етапі запиту, serving-API чи моніторингу; повний чесний список підтвердженого та відкритого — у розділі «Відомі обмеження» в технічній частині нижче.
