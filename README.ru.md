...
Production-обвязка в духе Docker/FastAPI/observability, присутствующая у некоторых конкурентов-портфолио (см. «Сравнение с похожими портфолио-проектами по финансовому RAG» ниже) — не принято: это не закрывает реальный пробел этого проекта (retrieval/generation error attribution — см. docs/tehnicheskoe_zadanie.md, раздел 21), а копирование инфраструктурной поверхности конкурентов не усилило бы собственную сильную сторону проекта — измерительную строгость.
