...
already tested in test_voyage_finance2_significance.py at the retrieval
...
count) as test_voyage_finance2_significance.py's mcnemar_exact(), applied
...
Usage (Colab, repo root, after both runs already exist under results/):
    !python test_routing_e2e_significance.py
"""
